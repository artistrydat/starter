...
# This SQL script generates a report of the database schema, including tables, columns, relationships, indexes, functions and policies.
...
functions as (
  select 
    ...
    'Parameters: ' || pg_get_function_arguments(p.oid) || 
...
select section, object_type, object_name, details from policies
union all
select section, object_type, object_name, details from functions
order by section, object_type, object_name;